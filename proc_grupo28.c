...
/*
 Sistemas Operativos 2 - Primer Semestre 2021
 Modulos de Kernel para Obtener estadisticas de los procesos del sistema
...
*/
    ...
    {
         printk(KERN_INFO "FIN ++++ SOMOS EL GRUPO #28 Y ESTE FUE EL MONITOR DE PROCESOS.\r\n");
         remove_proc_entry("proc_grupo28", NULL);
    }
    ...
    {
        printk(KERN_INFO "INICIO ++++ SOMOS EL GRUPO #28 Y ESTE ES EL MONITOR DE PROCESOS.\r\n");
        proc_create("proc_grupo28", 0777, NULL, &meminfo_proc_fops);
        return 0;
    }
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Grupo 28 , Sistemas Operativos 2 - 1er Semestre 2021");
